  ...
  const renderGroundCard = ({ item }) => {
    ...
    const coverImage =
      item.images && item.images.length > 0
        ? item.images[0].url
        : item.image_url || "https://via.placeholder.com/300x150?text=No+Image";

    return (
      <Card style={styles.card}>
        <Card.Cover source={{ uri: coverImage }} style={styles.cardImage} />
        <Card.Content style={styles.cardContent}>
          ...
          {/* Facilities as tags or simple text */}
