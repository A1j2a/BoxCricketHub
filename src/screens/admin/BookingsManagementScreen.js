    ...
    if (searchQuery) {
      ...
      results = results.filter(
        booking => 
          ...
          booking.slots?.grounds?.name?.toLowerCase().includes(lowercasedQuery) ||
      ...
      <View style={styles.bookingCard}>
        <View style={styles.bookingHeader}>
          <View style={styles.venueName}>
            ...
            <Text style={styles.venueText}>{item.slots?.grounds?.name || 'Unknown Venue'}</Text>
          </View>
          <Chip 
            style={[
              styles.statusChip,
        ...
        <View style={styles.detailsContainer}>
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{item.users?.name || 'Unknown'}</Text>
          </View>
          
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Date & Time:</Text>
            <Text style={styles.detailValue}>{date}, {startTime} - {endTime}</Text>
          </View>
